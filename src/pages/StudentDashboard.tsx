...
import { PlayCircle, Award, BookOpen, ChevronRight, Loader2, MessageSquare, Layout } from 'lucide-react';
...
export function StudentDashboard() {
  ...
  return (
    <div className="space-y-10 pb-20 relative z-10">
      ...
      {/* Tabs */}
      <div className="flex items-center space-x-8 border-b border-white/5 overflow-x-auto">
        {[
              ...
              {courses.map((course, index) => (
                ...
                >
                  ...
                  <div className="p-6 space-y-4 flex-grow flex flex-col">
                    ...
                    <div className="pt-4 mt-auto flex items-center justify-end border-t border-white/5">
